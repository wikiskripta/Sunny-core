...
site = pywikibot.Site()
namespaces = [6] # Namespace Soubor

pages = pagegenerators.CategorizedPageGenerator(
    category=pywikibot.Category(site, "Nezařazené soubory"),
    namespaces=namespaces
)
page_titles = [page.title() for page in pages]
print("Fetched " + str(len(page_titles)) + " file pages categorized in category \"Nezařazené soubory\"")
